...
from scripts.extract_sources_torre_transacoes import gerar_token, consultar_api, verificar_json_vazio, notificar_json_vazio, json_to_parquet
...
default_args = {
    ...
    #'email': ['fabio.pepplow@gritsch.com.br'],
...
with DAG(
    'ExtractSourcesTorreTransacoesPeriodo',
    tags=['TruckPag','API', 'Torre de Controle', 'Extracão', 'Manual', 'Sources'],
    ...
    tsk_notificar_vazio = PythonOperator(
        task_id="tsk_notificar_json_vazio",
